...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class TranslationResponse :  IEquatable<TranslationResponse>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TranslationResponse" /> class.
        /// </summary>
        /// <param name="translatedText">translatedText.</param>
        public TranslationResponse(string translatedText = default(string))
        {
        ...
        {
            return this.Equals(input as TranslationResponse);
        }

        /// <summary>
        /// Returns true if TranslationResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of TranslationResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TranslationResponse input)
        {
            if (input == null)
                return false;
            ...
            return 
                (
                    ...
                    this.TranslatedText.Equals(input.TranslatedText))
                );
        }
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.TranslatedText != null)
                    hashCode = hashCode * 59 + this.TranslatedText.GetHashCode();
                return hashCode;
            }
        }
